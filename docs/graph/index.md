...
!!! success "The graph is now a data artifact"
    The source of truth is **[`graph.json`](graph.json)** — **160 typed nodes** and
    **439 typed edges** curated from the Gold dossiers, comparative chapters, and pattern
...
|-----------|------:|-----------|------:|
| model | 48 | exhibits_pattern | 160 |
| pattern | 16 | realized_by | 58 |
| institution | 38 | developed_at | 43 |
| researcher | 25 | alternative_to | 38 |
| algorithm | 12 | belongs_to | 38 |
| paradigm | 8 | solves_with | 30 |
| domain | 8 | grounded_in | 15 |
| axis | 5 | positions | 10 |
| **Total nodes** | **160** | **Total edges** | **439** |
