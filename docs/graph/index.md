...
!!! success "The graph is now a data artifact"
    The source of truth is **[`graph.json`](graph.json)** — **86 typed nodes** and
    **121 typed edges** curated from the Gold dossiers, comparative chapters, and pattern
